...
| GitHub Actions 전체 CI/CD | **green**: 192 tests → GHCR push → k3d/Helm → curl smoke | [run #29486892909](https://github.com/ki0915/Mcp-Guard/actions/runs/29486892909), `workflow_dispatch`, 2026-07-16 |
...
- 전체 실증 실행: [GitHub Actions #29486892909](https://github.com/ki0915/Mcp-Guard/actions/runs/29486892909) — 192개 테스트, 합성 fixture gate, GHCR 이미지 실제 푸시, k3d/Helm 설치, 합성 curl smoke 성공
