...
| 원격 CI/CD가 끝까지 동작하는가? | [Actions #29486892909](https://github.com/ki0915/Mcp-Guard/actions/runs/29486892909): 192 tests, fixture gate, GHCR push, k3d/Helm, curl smoke 모두 성공 | 통과 |
